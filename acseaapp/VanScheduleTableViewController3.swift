...
class VanScheduleTableViewController3: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        self.tableView.register(CustomCell.self, forCellReuseIdentifier: "custom9")     // Do any additional setup after loading the view.9
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = self.tableView.dequeueReusableCell(withIdentifier: "custom9") as! CustomCell
