...
class TorScheduleTableViewController: UITableViewController {
     ...
     */
    func dayOne(){
        data = [TorScheduleCellData2.init(image: UIImage(named:"gobackbtn.png"), message: "Riding the waves with vietnam Cocnert \nBy maestro ken hsieh" ), TorScheduleCellData2.init(image: UIImage(named:"gobackbtn.png"), message: "One" ), TorScheduleCellData2.init(image: UIImage(named:"gobackbtn.png"), message: "One" ), TorScheduleCellData2.init(image: UIImage(named:"gobackbtn.png"), message: "One" ), TorScheduleCellData2.init(image: UIImage(named:"gobackbtn.png"), message: "One" ), TorScheduleCellData2.init(image: UIImage(named:"gobackbtn.png"), message: "One" ), ]
